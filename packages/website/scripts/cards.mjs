...
export const PAGE_CARDS = {
  ...
  tier: { kind: "Tier", title: "Buy a tier. The vault burns for you.", text: "10, 50, or 250 USDG from any wallet in the browser. The vault buys PAYHOLE with it and burns it; your reports count in the swarm.", footer: "payhole.org/tier.html" },
  link: { kind: "Link", title: "Let your phone report for your wallet.", text: "A tier holder signs one message and every report from the PayHole app counts as that wallet's flag in the swarm. No funds on the phone, ever.", footer: "payhole.org/link.html" },
  radar: { kind: "Radar", title: "What the network learned today.", text: "Names the swarm confirmed, how the lists grew, and the brands the new names impersonate. From swarm flags and list refreshes, never from lookups.", footer: "payhole.org/radar.html" },
