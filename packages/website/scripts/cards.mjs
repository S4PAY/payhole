...
export const PAGE_CARDS = {
  ...
  extension: { kind: "Extension", title: "A capped USDG pocket for your browser.", text: "Pages that ask for a cent get paid from an address that exists only for that site, never past your cap." },
